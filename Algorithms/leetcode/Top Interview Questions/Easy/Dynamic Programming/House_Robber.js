...
var rob = function(nums) {
    ...
    table[0] = nums[0]; //1
    table[1] = Math.max(nums[0], nums[1]); //2
...
let testArr = [2, 7, 9, 3, 1]

console.log(rob(testArr));

//input = array of positive numbers
//output = the maximum value as a sum of nonadjacent values
//tools = dynamic programming (tabulation)
//Edge cases = array of 1 - return value, empty array - return 0, array of 2 - return max
//Strategy:
