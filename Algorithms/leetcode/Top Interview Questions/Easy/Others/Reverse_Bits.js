...
// this case, both input and output will be given as signed integer type and should 
// not affect your implementation, as the internal binary representation of the integer 
...
let bin = 00000010100101000001111010011100;

console.log(reverseBits(bin));